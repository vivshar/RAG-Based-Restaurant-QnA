...
yelp_reviews = pd.read_json("yelp_academic_dataset_review.json", encoding = 'ISO-8859-1', lines=True, nrows=5000)
yelp_business = pd.read_json("yelp_academic_dataset_business.json", encoding = 'ISO-8859-1', lines=True)
...
sample_df['review'] = sample_df.apply(format_review, axis=1)
